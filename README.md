## Bitriel Extension
Our Bitriel is forked from SubWallet/extension, which is forked from polkadot-js/extension. We aim to adding more features while being able to rebase the polkadot-js origin at any time.
## Main Concept
![Main Concept](https://github.com/bitriel/BitrielWallet-Extension/wiki/images/ExtensionConcept.png)
