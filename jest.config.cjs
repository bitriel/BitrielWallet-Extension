...
module.exports = {
  ...
  moduleNameMapper: {
    '@bitriel/extension-(base|chains|compat-metamask|dapp|inject|mocks|koni-base|koni-ui|web-ui)(.*)$': '<rootDir>/packages/extension-$1/src/$2',
    // eslint-disable-next-line sort-keys
    '@bitriel/extension-koni(.*)$': '<rootDir>/packages/extension-koni/src/$1',
