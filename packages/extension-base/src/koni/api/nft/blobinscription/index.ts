...
import { COLLECT_ID } from '@bitriel/extension-base/koni/api/nft/blobinscription/consts';
import { ALC, getNftDetail, NftResponse, RemarkData, transferPayload } from '@bitriel/extension-base/koni/api/nft/blobinscription/types';
import { AVAIL_LIGHT_CLIENT_NFT } from '@bitriel/extension-base/koni/api/nft/config';
