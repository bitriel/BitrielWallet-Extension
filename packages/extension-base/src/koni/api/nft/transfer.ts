...
import { AssetHubNftType } from '@bitriel/extension-base/background/KoniTypes';
import { SUPPORTED_TRANSFER_SUBSTRATE_CHAIN_NAME } from '@bitriel/extension-base/koni/api/nft/config';
