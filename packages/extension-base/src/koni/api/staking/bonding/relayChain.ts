...
import { EarningStatus, NominationPoolInfo, PalletNominationPoolsBondedPoolInner, PalletStakingExposure, StakingTxErrorType, TernoaStakingRewardsStakingRewardsData, UnstakingStatus, ValidatorExtraInfo } from '@bitriel/extension-base/types';
