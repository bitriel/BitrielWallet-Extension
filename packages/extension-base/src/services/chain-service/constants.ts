...
import { _DEFAULT_CHAINS } from '@bitriel/chain-list';
import { _SubstrateChainType } from '@bitriel/chain-list/types';
import { SingleModeJson, ThemeNames } from '@bitriel/extension-base/background/KoniTypes';
