...
import { _getAssetDecimals, _getChainNativeTokenBasicInfo } from '@bitriel/extension-base/services/chain-service/utils';
import { AppBannerData, AppBasicInfoData, AppCommonData, AppConfirmationData, AppPopupData, ConditionBalanceType, ConditionCrowdloanType, ConditionEarningType, ConditionHasMoneyType, ConditionNftType, ConditionType, MktCampaignCondition, MktCampaignConditionTypeValue } from '@bitriel/extension-base/services/mkt-campaign-service/types';
import { fetchStaticData, TARGET_ENV, wait } from '@bitriel/extension-base/utils';
