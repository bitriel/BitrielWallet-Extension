...
import { EIP155_SIGNING_METHODS, POLKADOT_SIGNING_METHODS, WalletConnectSigningMethod } from '@bitriel/extension-base/services/wallet-connect-service/types';
import { targetIsMobile } from '@bitriel/extension-base/utils';
