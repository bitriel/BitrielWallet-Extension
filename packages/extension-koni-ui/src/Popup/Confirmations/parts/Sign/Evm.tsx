...
import { useGetAccountByAddress, useGetChainInfoByChainId, useLedger, useNotification } from '@bitriel/extension-koni-ui/hooks';
...
import { PhosphorIcon, SigData, ThemeProps } from '@bitriel/extension-koni-ui/types';
...
import { getSignMode, isEvmMessage, removeTransactionPersist } from '@bitriel/extension-koni-ui/utils';
...
const Component: React.FC<Props> = (props: Props) => {
  ...
  const { payload: { address, canSign, errors, hashPayload } } = payload;
