...
import { RequestSign } from '@bitriel/extension-base/background/types';
import { _isRuntimeUpdated, detectTranslate } from '@bitriel/extension-base/utils';
import { AlertBox, AlertModal } from '@bitriel/extension-koni-ui/components';
import { CONFIRMATION_QR_MODAL, NotNeedMigrationGens, SUBSTRATE_GENERIC_KEY, SUBSTRATE_MIGRATION_KEY } from '@bitriel/extension-koni-ui/constants';
import { InjectContext } from '@bitriel/extension-koni-ui/contexts/InjectContext';
import { useAlert, useGetAccountByAddress, useGetChainInfoByGenesisHash, useLedger, useMetadata, useNotification, useParseSubstrateRequestPayload, useSelector, useUnlockChecker } from '@bitriel/extension-koni-ui/hooks';
import { approveSignPasswordV2, approveSignSignature, cancelSignRequest, shortenMetadata } from '@bitriel/extension-koni-ui/messaging';
import { AccountSignMode, PhosphorIcon, SubstrateSigData, ThemeProps } from '@bitriel/extension-koni-ui/types';
import { getSignMode, isRawPayload, isSubstrateMessage, removeTransactionPersist, toShort } from '@bitriel/extension-koni-ui/utils';
