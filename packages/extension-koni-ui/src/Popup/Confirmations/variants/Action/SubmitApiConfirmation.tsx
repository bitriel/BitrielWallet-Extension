...
import { ConfirmationsQueueItem, SubmitApiRequest } from '@bitriel/extension-base/background/KoniTypes';
...
import { SubmitApiType, ThemeProps } from '@bitriel/extension-koni-ui/types';
