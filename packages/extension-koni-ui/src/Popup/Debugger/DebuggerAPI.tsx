...
import { MessageTypesWithSubscriptions } from '@bitriel/extension-base/background/types';
import { subscribeMessage } from '@bitriel/extension-koni-ui/messaging';
...
const API_LIST = [
  ...
  // 'pri(accounts.tie)',
  // 'pri(accounts.export.json)',
  // 'pri(accounts.export.privateKey)',
  // 'pri(accounts.batchExport)',
  // 'pri(accounts.validate.substrate.publicAndPrivateKey)',
