...
import { EmptyList, FilterModal, Layout } from '@bitriel/extension-koni-ui/components';
import { EarningOptionItem } from '@bitriel/extension-koni-ui/components/Earning';
import BannerGenerator from '@bitriel/extension-koni-ui/components/StaticContent/BannerGenerator';
import { ASTAR_PORTAL_URL, DEFAULT_EARN_PARAMS, EARN_TRANSACTION } from '@bitriel/extension-koni-ui/constants';
import { HomeContext } from '@bitriel/extension-koni-ui/contexts/screen/HomeContext';
import { useFilterModal, useGetBannerByScreen, useGroupYieldPosition, useHandleChainConnection, useSelector, useTranslation, useYieldGroupInfo } from '@bitriel/extension-koni-ui/hooks';
import { getBalanceValue } from '@bitriel/extension-koni-ui/hooks/screen/home/useAccountBalance';
import { ChainConnectionWrapper } from '@bitriel/extension-koni-ui/Popup/Home/Earning/shared/ChainConnectionWrapper';
import { EarningEntryView, EarningPoolsParam, ThemeProps, YieldGroupInfo } from '@bitriel/extension-koni-ui/types';
import { getTransactionFromAccountProxyValue, isRelatedToAstar, openInNewTab } from '@bitriel/extension-koni-ui/utils';
