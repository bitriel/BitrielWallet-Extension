...
import { AlertModal, Layout, PageWrapper } from '@bitriel/extension-koni-ui/components';
import { BN_TEN, BN_ZERO, DEFAULT_EARN_PARAMS, DEFAULT_UN_STAKE_PARAMS, EARN_TRANSACTION, UN_STAKE_TRANSACTION } from '@bitriel/extension-koni-ui/constants';
import { DataContext } from '@bitriel/extension-koni-ui/contexts/DataContext';
import { useAlert, useSelector, useTranslation, useYieldPositionDetail } from '@bitriel/extension-koni-ui/hooks';
import { AccountAndNominationInfoPart } from '@bitriel/extension-koni-ui/Popup/Home/Earning/EarningPositionDetail/AccountAndNominationInfoPart';
import { EarningInfoPart } from '@bitriel/extension-koni-ui/Popup/Home/Earning/EarningPositionDetail/EarningInfoPart';
import { RewardInfoPart } from '@bitriel/extension-koni-ui/Popup/Home/Earning/EarningPositionDetail/RewardInfoPart';
import { WithdrawInfoPart } from '@bitriel/extension-koni-ui/Popup/Home/Earning/EarningPositionDetail/WithdrawInfoPart';
import { EarningEntryParam, EarningEntryView, EarningPositionDetailParam, ThemeProps } from '@bitriel/extension-koni-ui/types';
import { getTransactionFromAccountProxyValue, isAccountAll, isChainInfoAccordantAccountChainType } from '@bitriel/extension-koni-ui/utils';
