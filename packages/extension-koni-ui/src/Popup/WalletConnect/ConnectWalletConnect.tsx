...
import { CloseIcon, Layout, QrScannerErrorNotice, WalletConnect } from '@bitriel/extension-koni-ui/components';
import { TIME_OUT_RECORD } from '@bitriel/extension-koni-ui/constants';
import { useDefaultNavigate, useOpenQrScanner } from '@bitriel/extension-koni-ui/hooks';
import { addConnection } from '@bitriel/extension-koni-ui/messaging';
import { FormCallbacks, ScannerResult, Theme, ThemeProps } from '@bitriel/extension-koni-ui/types';
import { noop, validWalletConnectUri } from '@bitriel/extension-koni-ui/utils';
