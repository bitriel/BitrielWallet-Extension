...
import { DELETE_ADDRESS_BOOK_MODAL, EDIT_ADDRESS_BOOK_MODAL } from '@bitriel/extension-koni-ui/constants';
import { useCopy, useNotification, useSelector } from '@bitriel/extension-koni-ui/hooks';
import { editContactAddress, removeContactAddress } from '@bitriel/extension-koni-ui/messaging';
import { FormCallbacks, FormFieldData, ThemeProps } from '@bitriel/extension-koni-ui/types';
import { noop, simpleCheckForm, toShort } from '@bitriel/extension-koni-ui/utils';
