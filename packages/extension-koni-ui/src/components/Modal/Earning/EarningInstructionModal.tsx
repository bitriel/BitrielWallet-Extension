...
import { InstructionItem } from '@bitriel/extension-koni-ui/components';
import { getInputValuesFromString } from '@bitriel/extension-koni-ui/components/Field/AmountInput';
import { EARNING_DATA_RAW, EARNING_INSTRUCTION_MODAL } from '@bitriel/extension-koni-ui/constants';
import { useSelector } from '@bitriel/extension-koni-ui/hooks';
import { earlyValidateJoin } from '@bitriel/extension-koni-ui/messaging';
import { AlertDialogProps, PhosphorIcon, ThemeProps } from '@bitriel/extension-koni-ui/types';
import { getBannerButtonIcon, getEarningTimeText, isAccountAll, isChainInfoAccordantAccountChainType } from '@bitriel/extension-koni-ui/utils';
...
const Component: React.FC<Props> = (props: Props) => {
  ...
  }, [closeAlert, targetAddress, onStakeMore, openAlert, setVisible, slug, t]);
