...
import { CONFIRM_TERM_SEED_PHRASE, TERM_AND_CONDITION_SEED_PHRASE_MODAL } from '@bitriel/extension-koni-ui/constants';
import useTranslation from '@bitriel/extension-koni-ui/hooks/common/useTranslation';
import { SeedPhraseTermStorage, Theme, ThemeProps } from '@bitriel/extension-koni-ui/types';
