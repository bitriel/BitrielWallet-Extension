...
import { InfoItemBase } from '@bitriel/extension-koni-ui/components/MetaInfo/parts/types';
import { EarningStatusUiProps, NominationPoolState } from '@bitriel/extension-koni-ui/types';
