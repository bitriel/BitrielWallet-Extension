...
import { ping } from '@bitriel/extension-koni-ui/messaging';
import { persistor, store, StoreName } from '@bitriel/extension-koni-ui/stores';
import { getMissionPoolData, getOldChainPrefixData, subscribeAccountsData, subscribeAddressBook, subscribeAliveProcess, subscribeAssetLogoMaps, subscribeAssetRegistry, subscribeAssetSettings, subscribeAuthorizeRequests, subscribeAuthUrls, subscribeBalance, subscribeBuyServices, subscribeBuyTokens, subscribeCampaignBannerData, subscribeCampaignConfirmationData, subscribeCampaignPopupData, subscribeCampaignPopupVisibility, subscribeChainInfoMap, subscribeChainLogoMaps, subscribeChainStakingMetadata, subscribeChainStateMap, subscribeChainStatusMap, subscribeConfirmationRequests, subscribeConfirmationRequestsCardano, subscribeConfirmationRequestsTon, subscribeConnectWCRequests, subscribeCrowdloan, subscribeKeyringState, subscribeLedgerGenericAllowNetworks, subscribeMantaPayConfig, subscribeMantaPaySyncingState, subscribeMetadataRequests, subscribeMultiChainAssetMap, subscribeNftCollections, subscribeNftItems, subscribePrice, subscribePriorityTokens, subscribeProcessingCampaign, subscribeRewardHistory, subscribeSigningRequests, subscribeStaking, subscribeStakingNominatorMetadata, subscribeStakingReward, subscribeSwapPairs, subscribeTransactionRequests, subscribeTxHistory, subscribeUiSettings, subscribeUnreadNotificationCount, subscribeWalletConnectSessions, subscribeWCNotSupportRequests, subscribeXcmRefMap, subscribeYieldMinAmountPercent, subscribeYieldPoolInfo, subscribeYieldPositionInfo, subscribeYieldReward } from '@bitriel/extension-koni-ui/stores/utils';
...
export const DataContextProvider = ({ children }: DataContextProviderProps) => {
  ...
  _DataContext.addHandler({ ...subscribeCampaignPopupVisibility, name: 'subscribeCampaignPopupVisibility', relatedStores: ['campaign'], isStartImmediately: true });
  ...
  _DataContext.addHandler({ ...subscribeAliveProcess, name: 'subscribeAliveProcess', relatedStores: ['requestState'], isStartImmediately: true });
  ...
  _DataContext.addHandler({ ...getOldChainPrefixData, name: 'getOldPrefixData', relatedStores: ['chainStore'], isStartImmediately: true });

  _DataContext.addHandler({ ...subscribeCampaignPopupData, name: 'subscribeCampaignPopup', relatedStores: ['staticContent'], isStartImmediately: true });
  _DataContext.addHandler({ ...subscribeCampaignBannerData, name: 'subscribeCampaignBanner', relatedStores: ['staticContent'], isStartImmediately: true });
  _DataContext.addHandler({ ...subscribeCampaignConfirmationData, name: 'subscribeCampaignConfirmation', relatedStores: ['staticContent'], isStartImmediately: true });
