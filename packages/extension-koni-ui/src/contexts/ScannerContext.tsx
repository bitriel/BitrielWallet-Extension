...
import { ResponseParseTransactionSubstrate, ResponseQrParseRLP, SignerDataType } from '@bitriel/extension-base/background/KoniTypes';
import { _isChainEnabled } from '@bitriel/extension-base/services/chain-service/utils';
import { createTransactionFromRLP, Transaction } from '@bitriel/extension-base/utils/eth';
import { MULTIPART, SCANNER_QR_STEP } from '@bitriel/extension-koni-ui/constants';
import { useTranslation } from '@bitriel/extension-koni-ui/hooks';
import { parseEVMTransaction, parseSubstrateTransaction, qrSignEvm, qrSignSubstrate } from '@bitriel/extension-koni-ui/messaging';
import { RootState } from '@bitriel/extension-koni-ui/stores';
import { CompletedParsedData, EthereumParsedData, MessageQRInfo, MultiFramesInfo, QrInfo, SubstrateCompletedParsedData, SubstrateMessageParsedData, SubstrateTransactionParsedData, TxQRInfo } from '@bitriel/extension-koni-ui/types/scanner';
import { constructDataFromBytes, encodeNumber, findAccountByAddress, getNetworkJsonByInfo, isEthereumCompletedParsedData, isSubstrateMessageParsedData } from '@bitriel/extension-koni-ui/utils';
