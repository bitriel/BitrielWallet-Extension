...
import { _ChainAsset, _MultiChainAsset } from '@bitriel/chain-list/types';
import { APIItemState, CurrencyJson } from '@bitriel/extension-base/background/KoniTypes';
import { _getAssetDecimals, _getAssetOriginChain, _getAssetPriceId, _getAssetSymbol, _getChainName, _getMultiChainAssetPriceId, _getMultiChainAssetSymbol, _isAssetValuable } from '@bitriel/extension-base/services/chain-service/utils';
import { RootState } from '@bitriel/extension-koni-ui/stores';
import { AssetRegistryStore, BalanceStore, ChainStore, PriceStore } from '@bitriel/extension-koni-ui/stores/types';
import { TokenBalanceItemType } from '@bitriel/extension-koni-ui/types/balance';
import { AccountBalanceHookType } from '@bitriel/extension-koni-ui/types/hook';
...
export default function useAccountBalance (tokenGroupMap: Record<string, string[]>, showZeroBalance?: boolean): AccountBalanceHookType {
  ...
  }, [assetRegistryMap, balanceMap, chainInfoMap, currency, currentAccountProxy?.id, isShowZeroBalance, multiChainAssetMap, price24hMap, priceMap, tokenGroupMap]);
}
