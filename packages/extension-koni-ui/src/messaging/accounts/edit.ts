...
import { RequestChangeTonWalletContractVersion, RequestGetAllTonWalletContractVersion, ResponseGetAllTonWalletContractVersion } from '@bitriel/extension-base/types';
...
export async function tonGetAllWalletContractVersion (request: RequestGetAllTonWalletContractVersion): Promise<ResponseGetAllTonWalletContractVersion> {
