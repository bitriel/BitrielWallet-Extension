...
import { MantaPayConfig, MantaPaySyncState } from '@bitriel/extension-base/background/KoniTypes';
import { MantaPayStore, ReduxStatus } from '@bitriel/extension-koni-ui/stores/types';
