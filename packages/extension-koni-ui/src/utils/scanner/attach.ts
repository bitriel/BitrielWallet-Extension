...
import { ETHEREUM_PREFIX, SCAN_TYPE, SECRET_PREFIX, SUBSTRATE_PREFIX } from '@bitriel/extension-koni-ui/constants';
import { QrAccount } from '@bitriel/extension-koni-ui/types';
