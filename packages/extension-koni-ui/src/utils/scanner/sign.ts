...
import { EthereumParsedData, MultiFramesInfo, NetworkParsedData, ParsedData, SubstrateCompletedParsedData, SubstrateMessageParsedData, SubstrateMultiParsedData } from '@bitriel/extension-koni-ui/types/scanner';
