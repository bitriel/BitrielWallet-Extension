...
import { MessageTypes, RequestSignatures, TransportRequestMessage } from '@bitriel/extension-base/background/types';
import { PORT_CONTENT, PORT_EXTENSION } from '@bitriel/extension-base/defaults';
...
import { startHeartbeat, stopHeartbeat } from '@bitriel/extension-koni/helper/HeartBeat';
