...
import { AccountItemWithName, AccountWithNameSkeleton, BasicOnChangeFunction, ChainSelector, CloseIcon, DualLogo, Layout, PageWrapper } from '@bitriel/extension-web-ui/components';
import { ATTACH_ACCOUNT_MODAL } from '@bitriel/extension-web-ui/constants';
import { useAutoNavigateToCreatePassword, useCompleteCreateAccount, useDefaultNavigate, useGetSupportedLedger, useGoBackFromCreateAccount, useLedger } from '@bitriel/extension-web-ui/hooks';
import { createAccountHardwareMultiple } from '@bitriel/extension-web-ui/messaging';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { ChainItemType, ThemeProps } from '@bitriel/extension-web-ui/types';
