...
import { CloseIcon, Layout, PageWrapper, PrivateKeyInput } from '@bitriel/extension-web-ui/components';
import InstructionContainer, { InstructionContentType } from '@bitriel/extension-web-ui/components/InstructionContainer';
import { EVM_ACCOUNT_TYPE } from '@bitriel/extension-web-ui/constants/account';
...
import { useAutoNavigateToCreatePassword, useCompleteCreateAccount, useDefaultNavigate, useFocusFormItem, useGetDefaultAccountName, useGoBackFromCreateAccount, useTranslation, useUnlockChecker } from '@bitriel/extension-web-ui/hooks';
import { createAccountSuriV2, validateMetamaskPrivateKeyV2 } from '@bitriel/extension-web-ui/messaging';
import { FormCallbacks, ThemeProps, ValidateState } from '@bitriel/extension-web-ui/types';
