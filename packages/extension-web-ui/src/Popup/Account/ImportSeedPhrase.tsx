...
import { CloseIcon, Layout, PageWrapper, PhraseNumberSelector, SeedPhraseInput } from '@bitriel/extension-web-ui/components';
import InstructionContainer, { InstructionContentType } from '@bitriel/extension-web-ui/components/InstructionContainer';
import { DEFAULT_ACCOUNT_TYPES, IMPORT_ACCOUNT_MODAL, IMPORT_SEED_MODAL, SELECTED_ACCOUNT_TYPE } from '@bitriel/extension-web-ui/constants';
import { ScreenContext } from '@bitriel/extension-web-ui/contexts/ScreenContext';
import { useAutoNavigateToCreatePassword, useCompleteCreateAccount, useDefaultNavigate, useFocusFormItem, useGetDefaultAccountName, useGoBackFromCreateAccount, useNotification, useTranslation, useUnlockChecker } from '@bitriel/extension-web-ui/hooks';
import { createAccountSuriV2, validateSeedV2 } from '@bitriel/extension-web-ui/messaging';
import { FormCallbacks, FormFieldData, FormRule, ThemeProps } from '@bitriel/extension-web-ui/types';
import { convertFieldToObject, noop, simpleCheckForm } from '@bitriel/extension-web-ui/utils';
