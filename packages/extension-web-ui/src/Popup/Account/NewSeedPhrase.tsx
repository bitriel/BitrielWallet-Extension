...
import { CloseIcon, InstructionContainer, InstructionContentType, Layout, PageWrapper, WordPhrase } from '@bitriel/extension-web-ui/components';
import { SeedPhraseTermModal } from '@bitriel/extension-web-ui/components/Modal/TermsAndConditions/SeedPhraseTermModal';
import { CONFIRM_TERM_SEED_PHRASE, DEFAULT_ACCOUNT_TYPES, DEFAULT_ROUTER_PATH, NEW_SEED_MODAL, SEED_PREVENT_MODAL, SELECTED_ACCOUNT_TYPE, TERM_AND_CONDITION_SEED_PHRASE_MODAL } from '@bitriel/extension-web-ui/constants';
import { ScreenContext } from '@bitriel/extension-web-ui/contexts/ScreenContext';
import { useAutoNavigateToCreatePassword, useCompleteCreateAccount, useDefaultNavigate, useGetDefaultAccountName, useIsPopup, useNotification, useTranslation, useUnlockChecker } from '@bitriel/extension-web-ui/hooks';
import { createAccountSuriV2, createSeedV2, windowOpen } from '@bitriel/extension-web-ui/messaging';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { ThemeProps } from '@bitriel/extension-web-ui/types';
import { isFirefox } from '@bitriel/extension-web-ui/utils';
