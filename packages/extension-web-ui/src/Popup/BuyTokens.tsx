...
import { BaseModal, baseServiceItems, Layout, PageWrapper, ServiceItem } from '@bitriel/extension-web-ui/components';
import { AccountSelector } from '@bitriel/extension-web-ui/components/Field/AccountSelector';
import { ServiceSelector } from '@bitriel/extension-web-ui/components/Field/BuyTokens/ServiceSelector';
import { TokenItemType, TokenSelector } from '@bitriel/extension-web-ui/components/Field/TokenSelector';
import { useAssetChecker, useDefaultNavigate, useNotification, useTranslation } from '@bitriel/extension-web-ui/hooks';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { AccountType, BuyServiceInfo, BuyTokenInfo, CreateBuyOrderFunction, SupportService, ThemeProps } from '@bitriel/extension-web-ui/types';
import { BuyTokensParam } from '@bitriel/extension-web-ui/types/navigation';
import { createBanxaOrder, createCoinbaseOrder, createTransakOrder, findAccountByAddress, noop, openInNewTab } from '@bitriel/extension-web-ui/utils';
import { getAccountType } from '@bitriel/extension-web-ui/utils/account/account';
import reformatAddress from '@bitriel/extension-web-ui/utils/account/reformatAddress';
