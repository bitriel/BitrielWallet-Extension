...
import { ConfirmationDefinitions, ConfirmationResult, EvmSendTransactionRequest, ExtrinsicType } from '@bitriel/extension-base/background/KoniTypes';
import { CONFIRMATION_QR_MODAL } from '@bitriel/extension-web-ui/constants/modal';
import { InjectContext } from '@bitriel/extension-web-ui/contexts/InjectContext';
import { useGetChainInfoByChainId, useLedger, useNotification } from '@bitriel/extension-web-ui/hooks';
import useUnlockChecker from '@bitriel/extension-web-ui/hooks/common/useUnlockChecker';
import { completeConfirmation } from '@bitriel/extension-web-ui/messaging';
import { PhosphorIcon, SigData, ThemeProps } from '@bitriel/extension-web-ui/types';
import { AccountSignMode } from '@bitriel/extension-web-ui/types/account';
import { EvmSignatureSupportType } from '@bitriel/extension-web-ui/types/confirmation';
import { convertErrorMessage, getSignMode, isEvmMessage, removeTransactionPersist } from '@bitriel/extension-web-ui/utils';
