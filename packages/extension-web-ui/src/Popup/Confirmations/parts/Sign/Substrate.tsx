...
import { CONFIRMATION_QR_MODAL, NotNeedMigrationGens, SUBSTRATE_GENERIC_KEY } from '@bitriel/extension-web-ui/constants';
import { InjectContext } from '@bitriel/extension-web-ui/contexts/InjectContext';
import { useGetChainInfoByGenesisHash, useLedger, useMetadata, useNotification, useParseSubstrateRequestPayload, useSelector, useUnlockChecker } from '@bitriel/extension-web-ui/hooks';
import { approveSignPasswordV2, approveSignSignature, cancelSignRequest, shortenMetadata } from '@bitriel/extension-web-ui/messaging';
import { AccountSignMode, PhosphorIcon, SubstrateSigData, ThemeProps } from '@bitriel/extension-web-ui/types';
import { convertErrorMessage, getSignMode, isRawPayload, isSubstrateMessage, removeTransactionPersist, toShort } from '@bitriel/extension-web-ui/utils';
