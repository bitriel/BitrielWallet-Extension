...
import { AddNetworkWCModal, AlertBox, ConfirmationGeneralInfo, WCAccountSelect, WCNetworkSelected } from '@bitriel/extension-web-ui/components';
import SeedPhraseModal from '@bitriel/extension-web-ui/components/Modal/Account/SeedPhraseModal';
import WCNetworkSupported from '@bitriel/extension-web-ui/components/WalletConnect/Network/WCNetworkSupported';
import { ADD_NETWORK_WALLET_CONNECT_MODAL, DEFAULT_ACCOUNT_TYPES, SELECTED_ACCOUNT_TYPE, WALLET_CONNECT_CREATE_MODAL } from '@bitriel/extension-web-ui/constants';
import { useNotification, useSelectWalletConnectAccount } from '@bitriel/extension-web-ui/hooks';
import { approveWalletConnectSession, rejectWalletConnectSession } from '@bitriel/extension-web-ui/messaging';
import { ThemeProps } from '@bitriel/extension-web-ui/types';
import { convertKeyTypes, isAccountAll } from '@bitriel/extension-web-ui/utils';
import { detectChanInfo } from '@bitriel/extension-web-ui/utils/chain/fetchNetworkByChainId';
