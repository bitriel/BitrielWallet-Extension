...
import { ConfirmationGeneralInfo, MetaInfo, ViewDetailIcon } from '@bitriel/extension-web-ui/components';
import { useGetAccountByAddress, useGetChainInfoByChainId, useOpenDetailModal } from '@bitriel/extension-web-ui/hooks';
