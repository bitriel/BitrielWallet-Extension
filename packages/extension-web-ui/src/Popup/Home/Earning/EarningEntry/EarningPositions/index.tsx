...
import { EarningRewardItem, YieldPoolType, YieldPositionInfo } from '@bitriel/extension-base/types';
import { AlertModal, BaseModal, EarningInstructionModal, EarningPositionDesktopItem, EarningPositionItem, EmptyList, FilterModal, Layout } from '@bitriel/extension-web-ui/components';
import { FilterTabsNode } from '@bitriel/extension-web-ui/components/FilterTabsNode';
import { ASTAR_PORTAL_URL, BN_TEN, CANCEL_UN_STAKE_TRANSACTION, CLAIM_REWARD_TRANSACTION, DEFAULT_CANCEL_UN_STAKE_PARAMS, DEFAULT_CLAIM_REWARD_PARAMS, DEFAULT_EARN_PARAMS, DEFAULT_UN_STAKE_PARAMS, DEFAULT_WITHDRAW_PARAMS, EARN_TRANSACTION, EARNING_INSTRUCTION_MODAL, TRANSACTION_YIELD_CANCEL_UNSTAKE_MODAL, TRANSACTION_YIELD_CLAIM_MODAL, TRANSACTION_YIELD_UNSTAKE_MODAL, TRANSACTION_YIELD_WITHDRAW_MODAL, UN_STAKE_TRANSACTION, WITHDRAW_TRANSACTION } from '@bitriel/extension-web-ui/constants';
import { ScreenContext } from '@bitriel/extension-web-ui/contexts/ScreenContext';
import { useAlert, useFilterModal, useSelector, useTranslation } from '@bitriel/extension-web-ui/hooks';
import { reloadCron } from '@bitriel/extension-web-ui/messaging';
import EarningPositionBalance from '@bitriel/extension-web-ui/Popup/Home/Earning/EarningEntry/EarningPositions/EarningPositionsBalance';
import { Toolbar } from '@bitriel/extension-web-ui/Popup/Home/Earning/shared/desktop/Toolbar';
import Transaction from '@bitriel/extension-web-ui/Popup/Transaction/Transaction';
import CancelUnstake from '@bitriel/extension-web-ui/Popup/Transaction/variants/CancelUnstake';
import ClaimReward from '@bitriel/extension-web-ui/Popup/Transaction/variants/ClaimReward';
import Unbond from '@bitriel/extension-web-ui/Popup/Transaction/variants/Unbond';
import Withdraw from '@bitriel/extension-web-ui/Popup/Transaction/variants/Withdraw';
import { EarningEntryView, EarningPositionDetailParam, ExtraYieldPositionInfo, Theme, ThemeProps } from '@bitriel/extension-web-ui/types';
import { isAccountAll, isRelatedToAstar, openInNewTab } from '@bitriel/extension-web-ui/utils';
