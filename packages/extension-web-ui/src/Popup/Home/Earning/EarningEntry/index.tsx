...
import { AlertModal, LoadingScreen, PageWrapper } from '@bitriel/extension-web-ui/components';
import { CREATE_RETURN, DEFAULT_ROUTER_PATH } from '@bitriel/extension-web-ui/constants';
import { DataContext } from '@bitriel/extension-web-ui/contexts/DataContext';
import { useAlert, useGroupYieldPosition, useSelector, useTranslation } from '@bitriel/extension-web-ui/hooks';
import EarningOptions from '@bitriel/extension-web-ui/Popup/Home/Earning/EarningEntry/EarningOptions';
import EarningPositions from '@bitriel/extension-web-ui/Popup/Home/Earning/EarningEntry/EarningPositions';
import { EarningEntryParam, EarningEntryView, ThemeProps } from '@bitriel/extension-web-ui/types';
