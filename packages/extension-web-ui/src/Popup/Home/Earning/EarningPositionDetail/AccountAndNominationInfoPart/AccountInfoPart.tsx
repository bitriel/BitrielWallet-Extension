...
import { Avatar, CollapsiblePanel, MetaInfo } from '@bitriel/extension-web-ui/components';
import { InfoItemBase } from '@bitriel/extension-web-ui/components/MetaInfo/parts';
import { EarningNominationModal } from '@bitriel/extension-web-ui/components/Modal/Earning';
import { EARNING_NOMINATION_MODAL, EarningStatusUi } from '@bitriel/extension-web-ui/constants';
import { useSelector, useTranslation } from '@bitriel/extension-web-ui/hooks';
import { EarningTagType, ThemeProps } from '@bitriel/extension-web-ui/types';
import { createEarningTypeTags, findAccountByAddress, isAccountAll, toShort } from '@bitriel/extension-web-ui/utils';
