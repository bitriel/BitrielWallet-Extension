...
import { ASTAR_PORTAL_URL, BN_ZERO, CLAIM_REWARD_TRANSACTION, DEFAULT_CLAIM_REWARD_PARAMS, EarningStatusUi } from '@bitriel/extension-web-ui/constants';
...
import { customFormatDate, openInNewTab } from '@bitriel/extension-web-ui/utils';
