...
import { CollapsiblePanel, MetaInfo } from '@bitriel/extension-web-ui/components';
import { CANCEL_UN_STAKE_TRANSACTION, DEFAULT_CANCEL_UN_STAKE_PARAMS, DEFAULT_WITHDRAW_PARAMS, WITHDRAW_TRANSACTION } from '@bitriel/extension-web-ui/constants';
import { useTranslation } from '@bitriel/extension-web-ui/hooks';
import { getWaitingTime } from '@bitriel/extension-web-ui/Popup/Transaction/helper';
