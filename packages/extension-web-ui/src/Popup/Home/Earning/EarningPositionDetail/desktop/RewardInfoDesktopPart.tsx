...
import { EarningRewardsHistoryModal } from '@bitriel/extension-web-ui/components/Modal/Earning/EarningRewardsHistoryModal';
import { BN_ZERO, CLAIM_REWARD_TRANSACTION, DEFAULT_CLAIM_REWARD_PARAMS, TRANSACTION_YIELD_CLAIM_MODAL } from '@bitriel/extension-web-ui/constants';
import { ScreenContext } from '@bitriel/extension-web-ui/contexts/ScreenContext';
import { useSelector, useTranslation, useYieldRewardTotal } from '@bitriel/extension-web-ui/hooks';
