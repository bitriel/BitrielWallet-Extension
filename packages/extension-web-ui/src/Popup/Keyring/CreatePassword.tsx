...
import { AlertBox, BaseModal, InfoIcon, InstructionContainer, InstructionContentType, Layout, PageWrapper } from '@bitriel/extension-web-ui/components';
import { CREATE_RETURN, REQUEST_CREATE_PASSWORD_MODAL, TERMS_OF_SERVICE_URL } from '@bitriel/extension-web-ui/constants';
...
import { useFocusFormItem, useNotification, useTranslation } from '@bitriel/extension-web-ui/hooks';
import { keyringChangeMasterPassword } from '@bitriel/extension-web-ui/messaging';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { ThemeProps } from '@bitriel/extension-web-ui/types';
import { renderBaseConfirmPasswordRules, renderBasePasswordRules, simpleCheckForm } from '@bitriel/extension-web-ui/utils';
