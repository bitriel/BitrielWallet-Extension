...
import InfoIcon from '@bitriel/extension-web-ui/components/Icon/InfoIcon';
import { DEFAULT_ROUTER_PATH, WALLET_CONNECT_CREATE_MODAL } from '@bitriel/extension-web-ui/constants';
...
import useFocusFormItem from '@bitriel/extension-web-ui/hooks/form/useFocusFormItem';
import { rejectWalletConnectSession, upsertChain, validateCustomChain } from '@bitriel/extension-web-ui/messaging';
import { Theme, ThemeProps, ValidateStatus } from '@bitriel/extension-web-ui/types';
import { noop } from '@bitriel/extension-web-ui/utils';
import { fetchChainInfo } from '@bitriel/extension-web-ui/utils/chain/fetchNetworkByChainId';
