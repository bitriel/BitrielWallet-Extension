...
import { AccountItemWithName, EmptyList, Layout, PageWrapper } from '@bitriel/extension-web-ui/components';
import { ActionItemType, ActionModal } from '@bitriel/extension-web-ui/components/Modal/ActionModal';
import useDefaultNavigate from '@bitriel/extension-web-ui/hooks/router/useDefaultNavigate';
import { changeAuthorization, changeAuthorizationPerAccount, forgetSite, toggleAuthorization } from '@bitriel/extension-web-ui/messaging';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { updateAuthUrls } from '@bitriel/extension-web-ui/stores/utils';
import { Theme, ThemeProps } from '@bitriel/extension-web-ui/types';
import { ManageWebsiteAccessDetailParam } from '@bitriel/extension-web-ui/types/navigation';
