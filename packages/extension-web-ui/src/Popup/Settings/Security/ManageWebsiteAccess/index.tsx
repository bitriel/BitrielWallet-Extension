...
import { ActionItemType, ActionModal, EmptyList, FilterModal, Layout, PageWrapper, WebsiteAccessItem } from '@bitriel/extension-web-ui/components';
import { useDefaultNavigate, useFilterModal } from '@bitriel/extension-web-ui/hooks';
import { changeAuthorizationAll, forgetAllSite } from '@bitriel/extension-web-ui/messaging';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { updateAuthUrls } from '@bitriel/extension-web-ui/stores/utils';
import { ManageWebsiteAccessDetailParam, Theme, ThemeProps } from '@bitriel/extension-web-ui/types';
