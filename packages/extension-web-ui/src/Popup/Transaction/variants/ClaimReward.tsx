...
import { AccountJson, EarningRewardItem, YieldPoolType, YieldPositionInfo } from '@bitriel/extension-base/types';
import { isSameAddress } from '@bitriel/extension-base/utils';
import { AccountSelector, HiddenInput, MetaInfo } from '@bitriel/extension-web-ui/components';
import { BN_ZERO } from '@bitriel/extension-web-ui/constants';
import { ScreenContext } from '@bitriel/extension-web-ui/contexts/ScreenContext';
import { useGetNativeTokenBasicInfo, useHandleSubmitTransaction, useInitValidateTransaction, usePreCheckAction, useRestoreTransaction, useSelector, useTransactionContext, useWatchTransaction, useYieldPositionDetail } from '@bitriel/extension-web-ui/hooks';
import { yieldSubmitStakingClaimReward } from '@bitriel/extension-web-ui/messaging';
import { ClaimRewardParams, FormCallbacks, FormFieldData, ThemeProps } from '@bitriel/extension-web-ui/types';
import { convertFieldToObject, isAccountAll, simpleCheckForm } from '@bitriel/extension-web-ui/utils';
