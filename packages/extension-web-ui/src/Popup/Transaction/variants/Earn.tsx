...
import { _handleDisplayInsufficientEarningError } from '@bitriel/extension-base/core/logic-validation/earning';
import { getValidatorLabel } from '@bitriel/extension-base/koni/api/staking/bonding/utils';
import { _getAssetDecimals, _getAssetSymbol, _getSubstrateGenesisHash, _isChainEvmCompatible } from '@bitriel/extension-base/services/chain-service/utils';
...
import { EarningStatus, NominationPoolInfo, OptimalYieldPath, OptimalYieldPathParams, SubmitJoinNativeStaking, SubmitJoinNominationPool, SubmitYieldJoinData, ValidatorInfo, YieldPoolInfo, YieldPoolType, YieldStepType } from '@bitriel/extension-base/types';
import { addLazy } from '@bitriel/extension-base/utils';
import { AccountSelector, AlertBox, AmountInput, EarningPoolSelector, EarningValidatorSelector, HiddenInput, InfoIcon, LoadingScreen, MetaInfo } from '@bitriel/extension-web-ui/components';
import { EarningProcessItem } from '@bitriel/extension-web-ui/components/Earning';
import { getInputValuesFromString } from '@bitriel/extension-web-ui/components/Field/AmountInput';
import { EarningInstructionModal } from '@bitriel/extension-web-ui/components/Modal/Earning';
import { CREATE_RETURN, DEFAULT_ROUTER_PATH, EARNING_INSTRUCTION_MODAL, EVM_ACCOUNT_TYPE, STAKE_ALERT_DATA, SUBSTRATE_ACCOUNT_TYPE } from '@bitriel/extension-web-ui/constants';
import { ScreenContext } from '@bitriel/extension-web-ui/contexts/ScreenContext';
import { WebUIContext } from '@bitriel/extension-web-ui/contexts/WebUIContext';
import { useChainConnection, useFetchChainState, useGetBalance, useGetNativeTokenSlug, useInitValidateTransaction, usePreCheckAction, useRestoreTransaction, useSelector, useSetSelectedAccountTypes, useTransactionContext, useWatchTransaction, useYieldPositionDetail } from '@bitriel/extension-web-ui/hooks';
import { fetchPoolTarget, getOptimalYieldPath, submitJoinYieldPool, validateYieldProcess } from '@bitriel/extension-web-ui/messaging';
// import { unlockDotCheckCanMint } from '@bitriel/extension-web-ui/messaging/campaigns';
import { DEFAULT_YIELD_PROCESS, EarningActionType, earningReducer } from '@bitriel/extension-web-ui/reducer';
import { store } from '@bitriel/extension-web-ui/stores';
import { EarnParams, FormCallbacks, FormFieldData, Theme, ThemeProps } from '@bitriel/extension-web-ui/types';
import { convertFieldToObject, getValidatorKey, isAccountAll, parseNominations, reformatAddress, simpleCheckForm } from '@bitriel/extension-web-ui/utils';
