...
import { _getAssetDecimals, _getAssetOriginChain, _getAssetSymbol, _getChainNativeTokenSlug, _getOriginChainOfAsset, _isChainEvmCompatible, _parseAssetRefKey } from '@bitriel/extension-base/services/chain-service/utils';
import { getSwapAlternativeAsset } from '@bitriel/extension-base/services/swap-service/utils';
import { SWTransactionResponse } from '@bitriel/extension-base/services/transaction-service/types';
import { CommonFeeComponent, CommonOptimalSwapPath, CommonStepType } from '@bitriel/extension-base/types/service-base';
import { CHAINFLIP_SLIPPAGE, SIMPLE_SWAP_SLIPPAGE, SlippageType, SwapFeeType, SwapProviderId, SwapQuote, SwapRequest } from '@bitriel/extension-base/types/swap';
import { formatNumberString, isAccountAll, swapCustomFormatter } from '@bitriel/extension-base/utils';
import { AccountSelector, AddMoreBalanceModal, AddressInput, AlertBox, ChooseFeeTokenModal, HiddenInput, MetaInfo, PageWrapper, QuoteResetTime, SlippageModal, SwapFromField, SwapIdleWarningModal, SwapQuotesSelectorModal, SwapRoute, SwapTermsOfServiceModal, SwapToField } from '@bitriel/extension-web-ui/components';
import { BN_TEN, BN_ZERO, CONFIRM_SWAP_TERM, DEFAULT_SWAP_PARAMS, SWAP_ALL_QUOTES_MODAL, SWAP_CHOOSE_FEE_TOKEN_MODAL, SWAP_IDLE_WARNING_MODAL, SWAP_MORE_BALANCE_MODAL, SWAP_SLIPPAGE_MODAL, SWAP_TERMS_OF_SERVICE_MODAL } from '@bitriel/extension-web-ui/constants';
...
import { useChainConnection, useNotification, usePreCheckAction, useSelector, useTransactionContext, useWatchTransaction } from '@bitriel/extension-web-ui/hooks';
import { getLatestSwapQuote, handleSwapRequest, handleSwapStep, validateSwapProcess } from '@bitriel/extension-web-ui/messaging/transaction/swap';
import { FreeBalance, FreeBalanceToEarn, TransactionContent, TransactionFooter } from '@bitriel/extension-web-ui/Popup/Transaction/parts';
import { CommonActionType, commonProcessReducer, DEFAULT_COMMON_PROCESS } from '@bitriel/extension-web-ui/reducer';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { Theme } from '@bitriel/extension-web-ui/themes';
import { FormCallbacks, FormFieldData, SwapParams, ThemeProps, TokenSelectorItemType } from '@bitriel/extension-web-ui/types';
import { convertFieldToObject, findAccountByAddress } from '@bitriel/extension-web-ui/utils';
