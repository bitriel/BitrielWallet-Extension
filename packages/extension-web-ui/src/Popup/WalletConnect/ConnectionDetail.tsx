...
import { AccountItemWithName, EmptyList, GeneralEmptyList, Layout, MetaInfo, PageWrapper, WCNetworkAvatarGroup } from '@bitriel/extension-web-ui/components';
import { BaseModal } from '@bitriel/extension-web-ui/components/Modal/BaseModal';
import { WALLET_CONNECT_DETAIL_MODAL } from '@bitriel/extension-web-ui/constants';
import { DataContext } from '@bitriel/extension-web-ui/contexts/DataContext';
import { useConfirmModal, useNotification, useSelector } from '@bitriel/extension-web-ui/hooks';
import { disconnectWalletConnectConnection } from '@bitriel/extension-web-ui/messaging';
import { ReduxStatus } from '@bitriel/extension-web-ui/stores/types';
import { Theme, ThemeProps, WalletConnectChainInfo } from '@bitriel/extension-web-ui/types';
import { chainsToWalletConnectChainInfos, getWCAccountList, noop } from '@bitriel/extension-web-ui/utils';
