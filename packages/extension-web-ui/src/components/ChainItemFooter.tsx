...
import { ChainInfoWithState } from '@bitriel/extension-web-ui/hooks/chain/useChainInfoWithState';
...
import { updateChainActiveState } from '@bitriel/extension-web-ui/messaging';
