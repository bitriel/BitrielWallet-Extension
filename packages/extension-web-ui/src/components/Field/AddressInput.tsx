...
import { CHAINS_SUPPORTED_DOMAIN, isAzeroDomain } from '@bitriel/extension-base/koni/api/dotsama/domain';
...
import { useForwardInputRef, useOpenQrScanner, useSelector, useTranslation } from '@bitriel/extension-web-ui/hooks';
import { resolveAddressToDomain, resolveDomainToAddress, saveRecentAccount } from '@bitriel/extension-web-ui/messaging';
import { ScannerResult, ThemeProps } from '@bitriel/extension-web-ui/types';
import { findContactByAddress, toShort } from '@bitriel/extension-web-ui/utils';
