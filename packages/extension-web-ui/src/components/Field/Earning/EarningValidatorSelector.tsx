...
import { ChainRecommendValidator } from '@bitriel/extension-base/constants';
...
import { detectTranslate, fetchStaticData } from '@bitriel/extension-base/utils';
import { BaseModal, SelectValidatorInput, StakingValidatorItem } from '@bitriel/extension-web-ui/components';
import EmptyValidator from '@bitriel/extension-web-ui/components/Account/EmptyValidator';
import { BasicInputWrapper } from '@bitriel/extension-web-ui/components/Field/Base';
import { EarningValidatorDetailModal } from '@bitriel/extension-web-ui/components/Modal/Earning';
import { FilterModal } from '@bitriel/extension-web-ui/components/Modal/FilterModal';
import { SortingModal } from '@bitriel/extension-web-ui/components/Modal/SortingModal';
import { VALIDATOR_DETAIL_MODAL } from '@bitriel/extension-web-ui/constants';
import { useFilterModal, useGetPoolTargetList, useSelector, useSelectValidators, useYieldPositionDetail } from '@bitriel/extension-web-ui/hooks';
import { ThemeProps, ValidatorDataType } from '@bitriel/extension-web-ui/types';
import { autoSelectValidatorOptimally } from '@bitriel/extension-web-ui/utils';
import { getValidatorKey } from '@bitriel/extension-web-ui/utils/transaction/stake';
