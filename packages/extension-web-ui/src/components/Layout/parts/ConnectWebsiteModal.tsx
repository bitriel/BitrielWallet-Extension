...
import ConfirmationGeneralInfo from '@bitriel/extension-web-ui/components/Confirmation/ConfirmationGeneralInfo';
import { changeAuthorizationBlock, changeAuthorizationPerSite } from '@bitriel/extension-web-ui/messaging';
