...
import { ReceiveQrModal, TokensSelectorModal } from '@bitriel/extension-web-ui/components/Modal';
...
import { BUY_TOKEN_MODAL, DEFAULT_TRANSFER_PARAMS, TRANSACTION_TRANSFER_MODAL, TRANSFER_TRANSACTION } from '@bitriel/extension-web-ui/constants';
...
import { BackgroundColorMap, WebUIContext } from '@bitriel/extension-web-ui/contexts/WebUIContext';
import { useNotification, useReceiveQR, useSelector, useTranslation } from '@bitriel/extension-web-ui/hooks';
import { reloadCron, saveShowBalance } from '@bitriel/extension-web-ui/messaging';
import BuyTokens from '@bitriel/extension-web-ui/Popup/BuyTokens';
import Transaction from '@bitriel/extension-web-ui/Popup/Transaction/Transaction';
import SendFund from '@bitriel/extension-web-ui/Popup/Transaction/variants/SendFund';
import { RootState } from '@bitriel/extension-web-ui/stores';
import { BuyTokenInfo, PhosphorIcon, ThemeProps } from '@bitriel/extension-web-ui/types';
import { getAccountType, isAccountAll } from '@bitriel/extension-web-ui/utils';
