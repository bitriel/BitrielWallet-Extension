...
import { MenuItem, MenuItemType } from '@bitriel/extension-web-ui/components/Layout/parts/SideMenu/MenuItem';
import { CONTACT_US, DEFAULT_SWAP_PARAMS, FAQS_URL, MISSIONS_POOL_LIVE_ID, SWAP_TRANSACTION, TERMS_OF_SERVICE_URL } from '@bitriel/extension-web-ui/constants';
...
import { computeStatus, isAccountAll, openInNewTab } from '@bitriel/extension-web-ui/utils';
