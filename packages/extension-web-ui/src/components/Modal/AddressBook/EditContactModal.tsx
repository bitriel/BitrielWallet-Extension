...
import { AddressJson } from '@bitriel/extension-base/types';
import { Avatar } from '@bitriel/extension-web-ui/components';
import { BaseModal } from '@bitriel/extension-web-ui/components/Modal/BaseModal';
import { DELETE_ADDRESS_BOOK_MODAL, EDIT_ADDRESS_BOOK_MODAL } from '@bitriel/extension-web-ui/constants';
import { useCopy, useNotification, useSelector } from '@bitriel/extension-web-ui/hooks';
import { editContactAddress, removeContactAddress } from '@bitriel/extension-web-ui/messaging';
import { FormCallbacks, FormFieldData, ThemeProps } from '@bitriel/extension-web-ui/types';
import { noop, simpleCheckForm, toShort } from '@bitriel/extension-web-ui/utils';
