...
import { HOME_CAMPAIGN_BANNER_MODAL } from '@bitriel/extension-web-ui/constants';
import { completeBannerCampaign } from '@bitriel/extension-web-ui/messaging/campaigns';
import { ThemeProps } from '@bitriel/extension-web-ui/types';
import { getBannerButtonIcon, openInNewTab } from '@bitriel/extension-web-ui/utils';
