...
import { balanceFormatter, detectTranslate, formatNumber } from '@bitriel/extension-base/utils';
import { BaseModal, InstructionItem } from '@bitriel/extension-web-ui/components';
import { getInputValuesFromString } from '@bitriel/extension-web-ui/components/Field/AmountInput';
import { EARNING_DATA_RAW, EARNING_INSTRUCTION_MODAL } from '@bitriel/extension-web-ui/constants';
import { ScreenContext } from '@bitriel/extension-web-ui/contexts/ScreenContext';
import { earlyValidateJoin } from '@bitriel/extension-web-ui/messaging';
import { AlertDialogProps, PhosphorIcon, ThemeProps } from '@bitriel/extension-web-ui/types';
import { getBannerButtonIcon } from '@bitriel/extension-web-ui/utils';
      ...
      <div className={'__buttons'}>
        ...
        {isShowStakeMoreButton && (
          <Button
            ...
            disabled={(!isWebUI && isDisableEarnButton) || isChainUnsupported}
            icon={
              <Icon
