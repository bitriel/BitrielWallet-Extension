...
import { PREDEFINED_WALLETS, SELECT_EXTENSION_MODAL } from '@bitriel/extension-web-ui/constants';
...
import { isAndroid, isFirefox, isIOS, isMobile, openInNewTab } from '@bitriel/extension-web-ui/utils';
