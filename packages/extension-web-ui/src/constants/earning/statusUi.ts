...
import { InfoItemBase } from '@bitriel/extension-web-ui/components/MetaInfo/parts/types';
import { EarningStatusUiProps, NominationPoolState } from '@bitriel/extension-web-ui/types';
