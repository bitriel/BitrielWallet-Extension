...
import { addLazy, createPromiseHandler } from '@bitriel/extension-base/utils';
import { Injected, InjectedAccountWithMeta, Unsubcall } from '@bitriel/extension-inject/types';
import { DisconnectExtensionModal } from '@bitriel/extension-web-ui/components';
import { AutoConnect, ENABLE_INJECT, PREDEFINED_WALLETS, SELECT_EXTENSION_MODAL, win } from '@bitriel/extension-web-ui/constants';
import { useNotification, useTranslation } from '@bitriel/extension-web-ui/hooks';
import { addInjects, removeInjects } from '@bitriel/extension-web-ui/messaging';
import { isMobile, noop, toShort } from '@bitriel/extension-web-ui/utils';
