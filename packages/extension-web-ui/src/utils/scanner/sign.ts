...
import { EthereumParsedData, MultiFramesInfo, NetworkParsedData, ParsedData, SubstrateCompletedParsedData, SubstrateMessageParsedData, SubstrateMultiParsedData } from '@bitriel/extension-web-ui/types/scanner';
