...
import { ID_PREFIX, PORT_CONTENT, PORT_EXTENSION, PORT_MOBILE } from '@bitriel/extension-base/defaults';
import { SWHandler } from '@bitriel/extension-base/koni/background/handlers';
import { VirtualMessageCenter } from '@bitriel/extension-web-ui/messaging/VirtualMessageCenter';
